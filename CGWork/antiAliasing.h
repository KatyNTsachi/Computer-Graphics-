...
{
public:
	static void blur(int * view_mat, int width,int height,int kernal_size, kernalTypes kernal_type, bool should_use_kernal);
	static void downSample(int * view_mat, int * rendering_view_mat, int width, int height, int kernal_size, kernalTypes kernal_type);
private:
